  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      try {
        ...
        const surveyData = {
          ...values,
          publicDate: values.publicDate ? new Date(values.publicDate).toISOString() : null,
    ...
    try {
      ...
      if (result.success) {
        ...
        formik.setValues({
          ...
          publicDate: surveyData.publicDate ? new Date(surveyData.publicDate).toISOString().split('T')[0] : null,
